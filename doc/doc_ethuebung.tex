...
\pkgcmddoc{uebHinweisParagraph}{ ... }

\pkgcmddoc{uebSerieTitle}{ ... }

\pkgcmddoc{uebHeaderLogo}{ ... }

\pkgcmddoc{uebHeaderCenter}{ ... }

\pkgcmddoc{uebHeaderRight}{ ... }

\pkgcmddoc{uebHeaderTopVSpace}{ ...  -15mm}

\pkgcmddoc{uebHeaderMidVSpace}{ ...  2mm}

\pkgcmddoc{uebHeaderBelowVSpace}{ ...  2mm}

\pkgcmddoc{uebHeaderLogoWidth}{ ...  .25\cmdname{textwidth}}

\pkgcmddoc{uebHeaderCenterWidth}{ ...  .50\cmdname{textwidth}}

\pkgcmddoc{uebHeaderRightWidth}{ ...  .2499\cmdname{textwidth}}

\pkgcmddoc{uebLoesungEndVSpace}{ ...  3mm}

\pkgcmddoc{uebTipsEndVSpace}{ ...  3mm}
