...
\pkgcmddoc{uebSerieTitle}{ ... }

%\pkgdefdefault|\ETHLogo|
\pkgcmddoc{uebHeaderLogo}{What should be displayed in the logo corner. By default, this
  command is simply defined as \pkgcmd{ETHLogo}. }

\pkgcmddoc{uebHeaderCenter}{ ... Look at \texttt{ethuebung.sty} for the default definition.}

\pkgcmddoc{uebHeaderRight}{ ... Look at \texttt{ethuebung.sty} for the default definition.}
