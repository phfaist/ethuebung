...
%\makeatletter
%\renewcommand{\uebHeaderMidVSpace}{2mm}
%\renewcommand\ueb@headerDueByLine{%
%  \vspace*{1ex}%
%  {%
%    \footnotesize%
%    \makebox[0.33\textwidth][l]{left}%
%    \hfill
%    \makebox[0.33\textwidth][c]{mid}%
%    \hfill
%    \makebox[0.33\textwidth][r]{right long text there you go some really long text}%
%  }%
%  \vspace*{-\baselineskip}%
%}%
%\renewcommand\ueb@headerDueByLine{}
...
% Note: if you want your own package options for xcolor, simply include your
% \usepackage... directive here, e.g.:
...
\UebungDiscussion{Next Wednesday}

\UebungSubHeaderPar[r]{\uebDueBy\\ Hi there!}
\UebungSubHeader[c]{Welcome to this lecture.}

\UebungSubHeaderLineFont{\scriptsize\itshape\bfseries}
...
%
% You can also remove the trailing dot in the title with with:
%
%\UebungStyle{NoDotInTitle}
...
%\UebungsblattNumber{} % Don't provide number (remember: comment out similar line below)
...
\DeclareMathOperator{\tr}{tr} % Use \tr for trace
...
% and for which this exercise would be relevant.
...
%
% you may put \exstarred before an item to display it with a star, usually to signify that
% this part of the exercise is more involved.
%
% `\exstarred' may be specified before \item, \exercise, or \subexercise. Don't add any
% spaces, please.
%
\exstarred\item Rewrite the Hamiltonian~\eqref{eq:HamiltonianFreeElectronGas} in the form
  \begin{align}
...
% "For the solution to this exercise, see p. XYZ"). More options in the user manual.
%
